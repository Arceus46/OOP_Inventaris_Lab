...
public class GUI_Barang extends javax.swing.JFrame{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        stok = Integer.parseInt(jTextField3.getText()); //merubah data dari String menjadi int
        ...
        return;
    }//Kondisi yang dimana jika salah satu data kosong maka akan menampilkan pesan
        
        if (selectedDate != null) { //kondisi yang dimana jika data tidak sama dengan kosong
        SimpleDateFormat sdf = new SimpleDateFormat("dd MMMM yyyy"); //format tanggal
        tgl = sdf.format(selectedDate); //inisialisasi data
        barang ye = new barang(stok, id, nama, tgl); //memanggil data barang melalui object
        ...
        jTextArea1.append("TANGGAL MASUK   : " + ye.tanggal_masuk+"\n");//Output dari input data
            ...
            //Pesan yang terjadi jika tanggal tidak diisi
        }
