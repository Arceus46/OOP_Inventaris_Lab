...
public class GUI_User extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (selectedDate != null) { //kondisi jika tanggal tidak kosong
            ...
            user pg;
            pg = new user(id, nama, tgl, alamat); //memanggil data user melalui object
            list.add(pg.getIdUser());
            list.add(pg.getNamaUser());
            list.add(pg.getAlamat());
            list.add(pg.getTanggalLahir());
