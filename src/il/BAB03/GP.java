 ...
 */
package il.BAB03;
import il.BAB02.inventaris_lab; //memanggil class inventaris_lab ke dalam gui gp
...
public class GP extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        inventaris_lab li = new inventaris_lab(); //memanggil data inventaris_lab melalui object
        li.denda = Integer.parseInt(jTextField2.getText()); //inisialisasi data
        li.id_peminjaman = jTextField1.getText(); //inisialisasi data
        li.id_user = jComboBox1.getSelectedItem().toString(); //inisialisasi data beserta konversi pilihan data menjadi String
        li.id_admin = jComboBox2.getSelectedItem().toString(); //inisialisasi data beserta konversi pilihan data menjadi String
        li.id_barang = jComboBox3.getSelectedItem().toString(); //inisialisasi data beserta konversi pilihan data menjadi String
        Date tp = jDateChooser2.getDate(); //inisialisasi data
        Date tk = jDateChooser1.getDate(); //inisialisasi data
        if (jTextField2.getText().trim().equals("") || 
        jTextField1.getText().trim().equals("")){
        JOptionPane.showMessageDialog(null, "Semua field harus diisi!", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    } //Kondisi yang dimana field harus diisi semua
        if (jComboBox1.getSelectedIndex() == 0) {
        JOptionPane.showMessageDialog(null, "Silakan pilih User yang valid!", "Error", JOptionPane.ERROR_MESSAGE);
        return;
        } //kondisi yang dimana combobox tidak boleh memilih yang tampil pertama
        ...
        jDateChooser1.setDate(null); // Reset tanggal kembali
        return;
    } //kondisi yang dimana tanggal kembali tidak boleh kurang dari tanggal pinjam
        SimpleDateFormat sdf = new SimpleDateFormat("dd MMMM yyyy"); //format tanggal
        li.tanggal_pinjam = sdf.format(tp); //inisialisasi data
        li.tanggal_kembali = sdf.format(tk); //inisialisasi data
        jTextArea1.append("Data Peminjaman\n");
        jTextArea1.append("--------------------------------------------------------\n");
        jTextArea1.append("ID Peminjaman                   : " + li.id_peminjaman +"\n");
        jTextArea1.append("ID User                                  : " + li.id_user + "\n");
        jTextArea1.append("ID Admin                               : " + li.id_admin+ "\n");
        jTextArea1.append("ID Barang                             : " + li.id_barang+"\n");
        jTextArea1.append("Tanggal Pinjam                   : " + li.tanggal_pinjam+"\n");
        jTextArea1.append("Tanggal Kembali                : " + li.tanggal_kembali+"\n");
        jTextArea1.append("Denda Jika Terlambat       : Rp." + li.denda+"\n"); //Output dari input data
        JOptionPane.showMessageDialog(null, "Data Berhasil di input!!!", "Sukses", JOptionPane.INFORMATION_MESSAGE);
        //Pesan yang menandakan data berhasil
    } else {
            JOptionPane.showMessageDialog(null, "Data Tanggal Tolong Diinput!", "Error", JOptionPane.ERROR_MESSAGE);
            //Pesan yang menandakan data tanggal tidak diinput
        }
